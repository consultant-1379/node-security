...
@Provider
public class CredentialServiceExceptionMapper implements ExceptionMapper<CredentialServiceException> {

    @Override
    public Response toResponse(final CredentialServiceException e) {
    ...
    private ErrorResponse getErrorReport(final CredentialServiceException e) {
        ...
        errorResponse.setErrorData(e.getErrorType() != null ? e.getErrorType().name() : null);
