...
public class IssueInitTrustedCertIpSecEnrollmentTaskHandlerTest {
    ...
    public void testProcessTaskSuccess() throws CppSecurityServiceException {
        ...
        Map <String, MoParam> paramsMap = mock(Map.class, withSettings().serializable());
        ...
        when(params.getParamMap()).thenReturn(paramsMap);
