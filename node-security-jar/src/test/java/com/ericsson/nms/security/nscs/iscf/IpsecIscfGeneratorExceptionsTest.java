...
public class IpsecIscfGeneratorExceptionsTest extends IscfTest {

    @Rule
    public ExpectedException thrown = ExpectedException.none();

    @Spy
    private final Logger log = LoggerFactory.getLogger(IpsecIscfGenerator.class);
    ...
    @Mock
    private IpsecDataCollector collector;

    @InjectMocks
    private IpsecIscfGenerator beanUnderTest;

    private final String name;
    private final Exception exception;

    public IpsecIscfGeneratorExceptionsTest(String name, Exception exception) {
        this.name = name;
