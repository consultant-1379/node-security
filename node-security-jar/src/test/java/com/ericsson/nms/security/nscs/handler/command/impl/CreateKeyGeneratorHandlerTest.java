...
public class CreateKeyGeneratorHandlerTest {

    public static final String SSH_KEY_CREATE = "Sshkey create command executed";

    @InjectMocks
    private CreateKeyGeneratorHandler createKeygenHandler;
    ...
    /**
     * Test method for
     * {@link com.ericsson.nms.security.nscs.handler.command.impl.CreateKeyGeneratorHandler#process(com.ericsson.nms.security.nscs.api.command.types.KeyGeneratorCommand, com.ericsson.nms.security.nscs.handler.CommandContext)}
     * .
     */
    ...
    public void testProcessException() {
        ...
        final NscsMessageCommandResponse response = (NscsMessageCommandResponse) createKeygenHandler.process(command, cmdctx);
    }
    ...
    public void testProcessResponse() {
        ...
        Assert.assertEquals(SSH_KEY_CREATE, response.getMessage());
    }
