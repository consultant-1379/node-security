...
/**
 * Test Class for CrlCheckDisableHandler.
 * 
 * @author xchowja
 *
 */
@RunWith(MockitoJUnitRunner.class)
public class CrlCheckDisableHandlerTest {
    ...
    @InjectMocks
    CrlCheckDisableHandler crlCheckDisableHandler;
    ...
    /**
     * Test method for
     * {@link com.ericsson.nms.security.nscs.handler.command.impl.CRLCheckDisableHandler#process(com.ericsson.nms.security.nscs.api.command.types.CRLCheckCommand, com.ericsson.nms.security.nscs.handler.CommandContext)}
     * .
     */
    @Test
    public void testProcess() {
        ...
        NscsCommandResponse response = crlCheckDisableHandler.process(command, context);
        Assert.assertEquals(((NscsMessageCommandResponse) response).getMessage(), String.format(CrlCheckDisableHandler.CRLCHECK_DISABLE_EXECUTED,jobStatusRecord.getJobId().toString()));
    }
    ...
    public void testProcess_InvalidArgumentValueException() {
        ...
        crlCheckDisableHandler.process(command, context);
     ...
     */
    @Test
    public void testProcess_CrlCheckDisableNotExecuted() {
        ...
        NscsCommandResponse response = crlCheckDisableHandler.process(command, context);
        Assert.assertEquals(((NscsNameMultipleValueCommandResponse) response).getAdditionalInformation(), CrlCheckDisableHandler.CRLCHECK_DISABLE_NOT_EXECUTED);
