...
public class SecurityLevelIscfGeneratorExceptionsTest extends IscfTest {

    @Rule
    public ExpectedException thrown = ExpectedException.none();

    @Spy
    private final Logger log = LoggerFactory.getLogger(SecurityLevelIscfGenerator.class);

    @Spy
    private RicGenerator ricGenerator;

    @Mock
    SecurityLevelIscfCreator creator;

    @Mock
    SecurityLevelDataCollector collector;

    @InjectMocks
    SecurityLevelIscfGenerator beanUnderTest;

    private final String name;
    private final Exception exception;

    public SecurityLevelIscfGeneratorExceptionsTest(String name, Exception exception) {
        this.name = name;
    ...
    public void testAllDataCollectorExceptions() throws Exception {
        ...
        doReturn(mockData).when(collector).getNodeAIData(Mockito.any(SecurityLevel.class),
