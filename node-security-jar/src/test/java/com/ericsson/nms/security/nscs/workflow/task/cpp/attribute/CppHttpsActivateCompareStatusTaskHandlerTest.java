...
public class CppHttpsActivateCompareStatusTaskHandlerTest {
    ...
    @InjectMocks
    private CppHttpsActivateCompareStatusTaskHandler statusTaskHandler;

    private CppHttpsActivateCompareStatusTask statusTask;

    @Before
    public void setUp() {
        statusTask = new CppHttpsActivateCompareStatusTask();
    ...
    public void processTaskShouldReturnCLIWhenHttpIsSet() {
        ...
        doReturn(HTTP).when(moAttributeHandler)
    ...
    @Test
    public void processTaskShouldReturnOMITWhenCppHttpsNotFalse() {

        doReturn(TRUE).when(moAttributeHandler)
