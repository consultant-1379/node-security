...
/**
 * Unit test for DisableCorbaSecurityTaskHandler
 * @author emaynes
 */
@RunWith(MockitoJUnitRunner.class)
public class DisableCorbaSecurityTaskHandlerTest {
    ...
    @InjectMocks
    private DisableCorbaSecurityTaskHandler handlerUnderTest;
    ...
    public void handlerInvocationTest() {
        ...
        final DisableCorbaSecurityTask task = new DisableCorbaSecurityTask(FDN);
