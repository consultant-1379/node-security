...
/**
 * Tests the SnmpAuthnoprivHandler that Updates a NetworkElementSecurity Mo associated to each of the specified nodes
 *
 * @see SnmpAuthnoprivHandler
 * @author ebarmos, emelant
 */
@RunWith(MockitoJUnitRunner.class)
public class SnmpAuthnoprivHandlerTest {
    ...
    @InjectMocks
    private SnmpAuthnoprivHandler beanUnderTest;
    ...
    /**
     * Tests SnmpAuthnoprivHandler Negative flow
     *
     * @throws Exception
     */
    @Test
    public void testProcess_SnmpAuthnoprivHandler_Negative() throws Exception {
    ...
    /**
     * Tests SnmpAuthnoprivHandler Positive flow
     *
     * @throws Exception
     */
    @Test
    public void testProcess_SnmpAuthnoprivHandler_Positive() throws Exception {
        final byte[] password = THEPASSORD.getBytes();
        ...
        assertTrue(SnmpAuthnoprivHandler.SNMP_AUTHNOPRIV_COMMAND_OK.equals(((NscsMessageCommandResponse) nscsResponse).getMessage()));
        ...
        verify(specificationBuilder).setFdn(Model.NETWORK_ELEMENT.securityFunction.networkElementSecurity.withNames(normalNode.getName()).fdn());
