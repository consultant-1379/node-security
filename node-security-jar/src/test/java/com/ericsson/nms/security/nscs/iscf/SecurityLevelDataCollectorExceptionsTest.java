...
public class SecurityLevelDataCollectorExceptionsTest extends IscfTest {
    ...
    public SecurityLevelDataCollectorExceptionsTest(String name, Exception exception) {
        this.name = name;
...
//            {"PKIManagerException", new PKIManagerException(PKIManagerException.Reason.FAILED_TO_PUBLISH_CERT)},
    ...
    public void testAllDataCollectorExceptions() throws Exception {
        ...
        doThrow(this.exception).when(collector).getNodeAIData(Mockito.any(SecurityLevel.class),
