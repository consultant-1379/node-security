...
/**
 * Tests the SnmpAuthprivParamsValidator
 *
 * @see SnmpAuthprivParamsValidator
 * @author ebarmos, emelant
 */
@RunWith(MockitoJUnitRunner.class)
public class SnmpAuthprivParamsValidatorTest {
    ...
    private static final String PRIV_PROTOCOL = "DES";
    private static final String PRIV_PROTOCOL_WRONG = "DEG";
    private static final String COMMAND_WRONG = "priv_wrong";
    ...
    @InjectMocks
    private SnmpAuthprivParamsValidator beanUnderTest;
    ...
    public void testProcess_validate() throws Exception {
        ...
        final SnmpAuthpriv command = setUpData(false, false, false);
    ...
    @Test
    public void testProcess_validate_wrong_attribute_auth() throws Exception {
        final SnmpAuthpriv command = setUpData(false, true, false);
    ...
    @Test
    public void testProcess_validate_wrong_attribute_priv() throws Exception {
        final SnmpAuthpriv command = setUpData(false, false, true);
    ...
    @Test
    public void testProcess_validate_wrong_argument_priv() throws Exception {

        final SnmpAuthpriv command = setUpData(true, false, true);
    ...
    private SnmpAuthpriv setUpData(final boolean wrongCommang, final boolean wrongAttribute, final boolean wrongAttributePriv) {
        final SnmpAuthpriv command = buildCommand(wrongCommang, wrongAttribute, wrongAttributePriv);
    ...
    private SnmpAuthpriv buildCommand(final boolean wrongCommang, final boolean wrongAttribute, final boolean wrongAttributePriv) {
        ...
        final Map<String, Object> commandMap = new HashMap<String, Object>() {
            private static final long serialVersionUID = 1L;
            {
                {
                    if (wrongCommang) {
                        put(COMMAND_WRONG, PRIV_PROTOCOL);
                        put(SnmpAuthpriv.AUTH_ALGO_PARAM, AUTH_PROTOCOL);
                    } else if (wrongAttribute) {
                        put(SnmpAuthpriv.PRIV_ALGO_PARAM, PRIV_PROTOCOL_WRONG);
                        put(SnmpAuthpriv.AUTH_ALGO_PARAM, AUTH_PROTOCOL);
                    } else if (wrongAttributePriv) {
                        put(SnmpAuthpriv.PRIV_ALGO_PARAM, PRIV_PROTOCOL);
                    ...
                    put(SnmpAuthpriv.PRIV_PWD_PARAM, NetworkElementSecurity.PRIV_KEY);
