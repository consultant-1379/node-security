...
public class KeyGeneratorUpdateMissingKeyPairValidatorTest {

    @InjectMocks
    private KeyGeneratorUpdateMissingKeyPairValidator missingkeypair;

    @Spy
    private final Logger logger = LoggerFactory.getLogger(KeyGeneratorUpdateMissingKeyPairValidator.class);
    ...
    @Mock
    private KeypairNotFoundException keypairexception;
    ...
    /**
     * Test method for
     * {@link com.ericsson.nms.security.nscs.handler.validation.impl.KeyGeneratorUpdateMissingKeyPairValidator#validate(com.ericsson.nms.security.nscs.api.command.NscsPropertyCommand, com.ericsson.nms.security.nscs.handler.CommandContext)}
     * .
     */
    @Test
    public void testValidate() {
        ...
        doThrow(RuntimeException.class).when(context).setAsInvalidOrFailed(nodeRef, keypairexception);

        missingkeypair.validate(command, context);
