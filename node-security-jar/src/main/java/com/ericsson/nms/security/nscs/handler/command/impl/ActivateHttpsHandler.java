 ...
 */
@CommandType(NscsCommandType.HTTPS_ACTIVATE)
@Local(CommandHandlerInterface.class)
public class ActivateHttpsHandler implements CommandHandler<HttpsCommand>, CommandHandlerInterface {
    ...
    public NscsCommandResponse process(final HttpsCommand command, final CommandContext context)
        ...
        return httpsCommandHandlerHelper.processActivate(command, context);
    }
}