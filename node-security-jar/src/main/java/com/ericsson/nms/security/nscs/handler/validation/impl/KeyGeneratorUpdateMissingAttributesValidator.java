 ...
 *
 */
public class KeyGeneratorUpdateMissingAttributesValidator implements CommandValidator {
    ...
    static {
        expectedAttributeKeys.add(KeyGeneratorCommand.NODE_LIST_PROPERTY);
        expectedAttributeKeys.add(KeyGeneratorCommand.NODE_LIST_FILE_PROPERTY);
    }
    ...
    public void validate(final NscsPropertyCommand command, final CommandContext context) throws NscsServiceException {
        ...
        if (command instanceof NscsPropertyCommand) {
            ...
            if (!command.getProperties().keySet().contains(KeyGeneratorCommand.NODE_LIST_PROPERTY)
                    && !command.getProperties().keySet().contains(KeyGeneratorCommand.NODE_LIST_FILE_PROPERTY)) {
