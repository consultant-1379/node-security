...
/**
 * <p>
 * Task handler for WorkflowTaskType.CPP_DISABLE_CORBA_SECURITY
 * </p>
 * <p>
 * Disables corba security on the node
 * </p>
 * @author  emaynes on 16/06/2014.
 */
@WFTaskType(WorkflowTaskType.CPP_DISABLE_CORBA_SECURITY)
@Local(WFTaskHandlerInterface.class)
public class DisableCorbaSecurityTaskHandler implements WFActionTaskHandler<DisableCorbaSecurityTask>, WFTaskHandlerInterface {
    ...
    @Override
    public void processTask(final DisableCorbaSecurityTask task) {
        ...
        sshCommandJob.setCommandToExecute(CPPCommands.SECMODE_L_1.toString());
        sshCommandJob.setNodeAddress(networkElementSecurityFdn);
        
        nscsLogger.workFlowTaskHandlerOngoing(task, "Execution of command: " + CPPCommands.SECMODE_L_1.toString() + "on node: " + networkElementSecurityFdn);
