...
import com.ericsson.oss.services.nscs.workflow.tasks.api.request.cpp.attribute.CppHttpsActivateCompareStatusTask;

/**
 * Created by ekrzsia on 9/18/17.
 */
@WFTaskType(WorkflowTaskType.CPP_COMPARE_HTTPS_STATUS_FOR_ACTIVATE)
@Local(WFTaskHandlerInterface.class)
public class CppHttpsActivateCompareStatusTaskHandler implements WFQueryTaskHandler<CppHttpsActivateCompareStatusTask>, WFTaskHandlerInterface {
    ...
    @Override
    public String processTask(final CppHttpsActivateCompareStatusTask task) {
        ...
        nscsLogger.workFlowTaskHandlerFinishedWithSuccess(task,
                "Webserver [" + webServer + "] " + "and cppConnectivityInformation [" + cppCIHttps
                        + "] attributes for node: [" + task.getNodeFdn() + "] were read successfully. "
