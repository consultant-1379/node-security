...
import com.ericsson.oss.services.nscs.workflow.tasks.api.request.comecim.attribute.ComEcimPrepareOnDemandCrlDownloadActionTask;
import com.ericsson.oss.services.nscs.workflow.utils.WorkflowOutputParameterKeys;

/**
 * <p>
 * Task handler for WorkflowTaskType.COM_ECIM_PREPARE_ON_DEMAND_CRL_DOWNLOAD.
 * </p>
 * <p>
 * Prepare, the MO action to start download crl on specified COM ECIM node.
 * </p>
 *
 * @author xramdag
 */

@WFTaskType(WorkflowTaskType.COM_ECIM_PREPARE_ON_DEMAND_CRL_DOWNLOAD)
@Local(WFTaskHandlerInterface.class)
public class ComEcimPrepareOnDemandCrlDownloadActionTaskHandler implements WFQueryTaskHandler<ComEcimPrepareOnDemandCrlDownloadActionTask>, WFTaskHandlerInterface {
    ...
    @Override
    public String processTask(final ComEcimPrepareOnDemandCrlDownloadActionTask task) {
        ...
        moAction.setState(WorkflowMoActionState.PENDING);
        ...
        final String successMessage = "Successfully completed : prepare [downloadCrl] action is in state [" + DONE + "]";
        nscsLogger.workFlowTaskHandlerFinishedWithSuccess(task, successMessage);
        return result;
    }

    private String prepareActionDone(final ComEcimPrepareOnDemandCrlDownloadActionTask task, final WorkflowMoActions moActions,
    ...
    private String serializeResult(final ComEcimPrepareOnDemandCrlDownloadActionTask task, final String result, final WorkflowMoActions moActions,
