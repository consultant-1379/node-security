...
@CommandType(NscsCommandType.SSO_ENABLE)
@Local(CommandHandlerInterface.class)
public class EnableSsoHandler implements CommandHandler<SsoCommand>, CommandHandlerInterface {
    ...
    public NscsCommandResponse process(final SsoCommand command, final CommandContext context) {
        return ssoCommandHandlerHelper.process(command, context, true);
    }
}
