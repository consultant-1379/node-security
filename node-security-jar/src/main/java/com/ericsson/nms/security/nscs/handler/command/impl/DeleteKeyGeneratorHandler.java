...
@CommandType(NscsCommandType.DELETE_SSH_KEY)
...
public class DeleteKeyGeneratorHandler implements CommandHandler<KeyGeneratorCommand>, CommandHandlerInterface  {
    @Inject
    ...
    public NscsCommandResponse process(KeyGeneratorCommand command, CommandContext context){
        return sshkeyCommandHandlerHelper.processSshKey(command, context, SSHKeyCommandHandlerHelper.SSHKeyConfigurationMode.DELETE_SSH_KEY);
    }
}
