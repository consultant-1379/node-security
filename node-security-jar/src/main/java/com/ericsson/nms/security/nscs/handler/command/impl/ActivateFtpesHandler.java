...
@CommandType(NscsCommandType.FTPES_ACTIVATE)
@Local(CommandHandlerInterface.class)
public class ActivateFtpesHandler implements CommandHandler<FtpesCommand>, CommandHandlerInterface {
    ...
    public NscsCommandResponse process(FtpesCommand command, CommandContext context) throws NscsServiceException {
        return ftpesCommandHandlerHelper.processActivate(command, context);
    }
