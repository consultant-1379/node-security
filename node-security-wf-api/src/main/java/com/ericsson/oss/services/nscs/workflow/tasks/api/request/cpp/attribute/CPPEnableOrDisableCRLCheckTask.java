...
/**
 * <p>
 * Workflow task representing a request to enable or disable CRL check process for CPP nodes
 * </p>
 * <p>
 * Default WorkflowTaskType used is WorkflowTaskType.CPP_ENABLE_OR_DISABLE_CRL_CHECK
 * </p>
 *
 * @author xlakdag
 */
public class CPPEnableOrDisableCRLCheckTask extends WorkflowQueryTask {
    ...
    public CPPEnableOrDisableCRLCheckTask() {
        super(WorkflowTaskType.CPP_ENABLE_OR_DISABLE_CRL_CHECK);
        setShortDescription(SHORT_DESCRIPTION);
    }

    public CPPEnableOrDisableCRLCheckTask(final String fdn) {
        super(WorkflowTaskType.CPP_ENABLE_OR_DISABLE_CRL_CHECK, fdn);
        setShortDescription(SHORT_DESCRIPTION);
    }
