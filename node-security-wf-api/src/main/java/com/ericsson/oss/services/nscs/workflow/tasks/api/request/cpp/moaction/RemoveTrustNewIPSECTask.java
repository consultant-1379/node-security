...
public class RemoveTrustNewIPSECTask extends WorkflowQueryTask {
    ...
    public static final String SHORT_DESCRIPTION = "Remove IPSEC trusted";

    public RemoveTrustNewIPSECTask() {
        super(WorkflowTaskType.CPP_REMOVE_TRUST_NEW_IPSEC);
        setValue(CERTIFICATE_SN, "");
        setValue(ISSUER, "");
        setShortDescription(SHORT_DESCRIPTION);
    }

    public RemoveTrustNewIPSECTask(final String name) {
        super(WorkflowTaskType.CPP_REMOVE_TRUST_NEW_IPSEC, name);
        setValue(CERTIFICATE_SN, "");
        setValue(ISSUER, "");
        setShortDescription(SHORT_DESCRIPTION);
    }
