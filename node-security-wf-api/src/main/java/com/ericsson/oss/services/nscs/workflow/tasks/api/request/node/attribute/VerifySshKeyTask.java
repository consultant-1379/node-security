 ...
 * </p>
 * <p>
 * Default WorkflowTaskType used is WorkflowTaskType.VERIFY_SSH_KEY
 * </p>
 */
public class VerifySshKeyTask extends WorkflowQueryTask {

    private static final long serialVersionUID = -5357446442029447510L;
    ...
    public static final String SHORT_DESCRIPTION = "Verify SSH Key";

    public VerifySshKeyTask() {
        super(WorkflowTaskType.VERIFY_SSH_KEY);
        setShortDescriptionLocal();
    }

    public VerifySshKeyTask(final String nodeName) {
        super(WorkflowTaskType.VERIFY_SSH_KEY, nodeName);
        setShortDescriptionLocal();
    }
    ...
    private void setShortDescriptionLocal() {
        super.setShortDescription(VerifySshKeyTask.SHORT_DESCRIPTION);
    }
