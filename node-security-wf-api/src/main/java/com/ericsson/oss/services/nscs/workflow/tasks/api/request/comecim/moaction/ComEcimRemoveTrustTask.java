...
public class ComEcimRemoveTrustTask extends WorkflowQueryTask {
    ...
    public static final String SHORT_DESCRIPTION = "Remove trusted";

    public ComEcimRemoveTrustTask() {
        super(WorkflowTaskType.COM_ECIM_REMOVE_TRUST);
    ...
    public ComEcimRemoveTrustTask(final String name) {
        super(WorkflowTaskType.COM_ECIM_REMOVE_TRUST, name);
        setValue(CERTIFICATE_SN_KEY, "");
        setValue(ISSUER_KEY, "");
        setValue(CERTIFICATE_CATEGORY_KEY, "");
        setValue(OUTPUT_PARAMS_KEY, null);
