...
public class CbpOiConfigureTrustReferenceTask extends WorkflowQueryTask {

    private static final long serialVersionUID = 1386312279001881637L;

    public static final String OUTPUT_PARAMS_KEY = WorkflowParameterKeys.OUTPUT_PARAMS.toString();

    public static final String SHORT_DESCRIPTION = "Configure Trust Reference for services";

    public CbpOiConfigureTrustReferenceTask() {
        super(WorkflowTaskType.CBPOI_CONFIGURE_SERVICES_TRUST_REFERENCE);
        setShortDescriptionLocal(SHORT_DESCRIPTION);
    }

    public CbpOiConfigureTrustReferenceTask(String fdn) {
        super(WorkflowTaskType.CBPOI_CONFIGURE_SERVICES_TRUST_REFERENCE, fdn);
        setShortDescriptionLocal(SHORT_DESCRIPTION);
    }
