...
public class CbpOiCheckCreateTrustCategoriesTask extends WorkflowQueryTask {

    private static final long serialVersionUID = -4132546901815172476L;

    public static final String OUTPUT_PARAMS_KEY = WorkflowParameterKeys.OUTPUT_PARAMS.toString();

    public static final String SHORT_DESCRIPTION = "Check and create Certificates objects relative to Trust Categories";

    public CbpOiCheckCreateTrustCategoriesTask() {
        super(WorkflowTaskType.CBPOI_CHECK_CREATE_TRUST_CATEGORIES);
        setShortDescriptionLocal(SHORT_DESCRIPTION);
    }

    public CbpOiCheckCreateTrustCategoriesTask(String fdn) {
        super(WorkflowTaskType.CBPOI_CHECK_CREATE_TRUST_CATEGORIES, fdn);
        setShortDescriptionLocal(SHORT_DESCRIPTION);
    }
