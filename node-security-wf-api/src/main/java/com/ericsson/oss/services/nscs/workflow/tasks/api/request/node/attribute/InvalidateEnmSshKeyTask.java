...
/**
 * <p>
 * Workflow task to invalidate ENM SSH keys for a node.
 * </p>
 * <p>
 * Default WorkflowTaskType used is WorkflowTaskType.INVALIDATE_ENM_SSH_KEY
 * </p>
 */
public class InvalidateEnmSshKeyTask extends WorkflowQueryTask {

    private static final long serialVersionUID = 8920887657540565715L;
    ...
    public static final String SHORT_DESCRIPTION = "Invalidate ENM SSH Key";

    public InvalidateEnmSshKeyTask() {
        super(WorkflowTaskType.INVALIDATE_ENM_SSH_KEY);
        setShortDescriptionLocal();
    }

    public InvalidateEnmSshKeyTask(final String nodeName) {
        super(WorkflowTaskType.INVALIDATE_ENM_SSH_KEY, nodeName);
        setShortDescriptionLocal();
    }
    ...
    private void setShortDescriptionLocal() {
        super.setShortDescription(InvalidateEnmSshKeyTask.SHORT_DESCRIPTION);
    }
