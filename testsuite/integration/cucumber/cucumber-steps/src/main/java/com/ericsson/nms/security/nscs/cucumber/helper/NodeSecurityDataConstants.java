...
public class NodeSecurityDataConstants {
    ...
    // added authpasswd e privpasswd
    public static final String AUTH_PASSWD = "snmpAuthKey";
    public static final String PRIV_PASSWD = "snmpPrivKey";

    // constants for MINI-LINK nodes:
    public static final String NODE_NAME_ML_INDOOR = "MINI-LINK-INDOOR_1";

    // constants for MINI-LINK-TN-LH nodes:
    public static final String NODE_NAME_ML_TN_LH = "MINI-LINK-TN-LH_1";
    ...
    //public static final String NODE_NAME = "ERBS1";
    //public static final String CPP_NAMESPACE = "ERBS_NODE_MODEL";
    //public static final String CPP_NAMESPACE_VERSION = "14.143.4";
    public static final String ERBS_NAMESPACE = "ERBS_NODE_MODEL";
    public static final String ERBS_NAMESPACE_VERSION = "10.4.252";
    ...
    public static final String SECURE_FILE_TRANSFER_CLIENT_MODE_VALUE = "SFTP";
    ...
    public static final String NETWORK_ELEMENT_OSS_MODEL_IDENTITY_VERSION = "6607-651-025";
    public static final String NETWORK_ELEMENT_OSS_MODEL_IDENTITY_RADIO_VERSION = "18.Q4-R57A02";
    ...
    public static final String NETWORK_ELEMENT_OSS_MODEL_IDENTITY_VERSION_COM_ECIM = "2392-793-223";
    public static final String MANAGED_ELEMENT_VERSION_VALUE_COM_ECIM = "10.10.1";
    ...
    public static final String LOCAL_AA_DATABASE_INSTALLATION_FAILURE_ATTRIBUTE = "localAADatabaseInstallationFailure";
    public static final String LOCAL_AUTHENTICATION_FILE_VERSION_ATTRIBUTE = "localAuthenticationFileVersion";
    public static final String LOCAL_AUTHERIZATION_FILE_VERSION_ATTRIBUTE = "localAuthorizationFileVersion";
    public static final String INSTALLED_TRUSTED_CERTIFICATES = "installedTrustedCertificates";
    public static final String NODE_CERT_INFO_SUBJECT_ATTRIBUTE = "subject";
    public static final String NODE_CERT_INFO_SUBJECT_VALUE = "CN=ENMManagementCA, OU=EricssonOAM, O=Ericsson";
    public static final String NODE_CERT_INFO_ISSUER_ATTRIBUTE = "issuer";
    public static final String NODE_CERT_INFO_ISSUER_VALUE = "CN=ENMInfrastructureCA, OU=EricssonOAM, O=Ericsson";
    public static final String NODE_CERT_INFO_SERIAL_NUMBER_ATTRIBUTE = "serialNumber";
    public static final String NODE_CERT_INFO_SERIAL_NUMBER_VALUE = "1418227216286";
    public static final String NODE_CERT_INFO_CATEGORY_ATTRIBUTE = "category";
    public static final String NODE_CERT_INFO_CATEGORY_VALUE = "LOCAL_AA_DB_FILE_SIGNERS";
    public static final String ERBS_TARGET_TYPE = "ERBS";
    public static final String VECE_TARGET_TYPE = "vECE";
    public static final String NETWORKELEMENT_SECURITY_SECURE_USER_NAME = "secureUserName";
    public static final String NETWORKELEMENT_SECURITY_SECURE_PASSPHRASE = "secureUserPassword";
    public static final String NETWORKELEMENT_SECURITY = "NetworkElementSecurity";
    public static final String FM_ALARM_SUPERVISION_MO = "FmAlarmSupervision";
    public static final String FM_SUPERVISION_MO_ATTR_ACTIVE = "active";
    public static final String FM_SUPERVISION_MO_ATTR_AUTOMATIC_SYNC = "automaticSynchronization";
    public static final String FM_SUPERVISION_MO_ATTR_ID = "FmAlarmSupervisionId";
    public static final String FM_SUPERVISION_MO_ATTR_HEARTBEAT_INTERVAL = "heartbeatinterval";
    public static final String FM_SUPERVISION_MO_ATTR_HEARTBEAT_TIMEOUT = "heartbeatTimeout";

    public static final String TIME_SETTING_MO = "TimeSetting";
    public static final String TIME_SETTING_ID_ATTRIBUTE = "TimeSettingId";
    public static final String TIME_SETTING_ID_ATTRIBUTE_VALUE = "1";
    public static final String INSTALLED_NTP_KEY_IDS_ATTRIBUTE = "installedNtpKeyIds";
    public static final Integer INSTALLED_NTP_KEY_IDS_ATTRIBUTE_STRING = 1;
    protected static final List<Integer> INSTALLED_NTP_KEY_IDS_ATTRIBUTE_VALUE = Arrays.asList(INSTALLED_NTP_KEY_IDS_ATTRIBUTE_STRING);
    public static final String NTP_SERVER_MO = "NtpServer";
    public static final String NTP_KEY_ID = "ntpKeyId";
    public static final int NTP_KEY_ID_VALUE = 7693;
    public static final String NTP_SERVER_ID = "NtpServerId";
    public static final String NTP_SERVER_ID_VALUE = "1";
    public static final String SERVER_ADDRESS = "serverAddress";
    public static final String SERVER_ADDRESS_VALUE = "192.16.66.6";
    public static final String SERVICE_STATUS = "serviceStatus";
    public static final String SERVICE_STATUS_VALUE = "SYSPEER";
    public static final String USER_LABEL = "userLabel";
    public static final String USER_LABEL_VALUE = "ENM";
    public static final String SERVICE_ACTIVE = "serviceActive";
    public static final String SERVICE_ACTIVE_VALUE = "true";
}
