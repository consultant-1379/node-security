...
public class NodeSecurityRadioNodesDataSetup extends NodeSecurityNodesDataSetup {
    ...
    public void createNode(final String nodeName, final String syncStatus, final SecurityLevel level) throws Exception {
        log.info("[NSCS_ARQ_DG2_NODES_DATA_SETUP] starting createNode {}", nodeName);
        ...
        String ossModelIdentity = getTargetModelIdentityForTestNode(NodeSecurityDataConstants.RADIO_TARGET_TYPE);
        final ManagedObject networkElment = createNetworkElementTree(liveBucket, parentMo, syncStatus, ossModelIdentity);

        commitTransaction();

        log.info("[NSCS_ARQ_DG2_NODES_DATA_SETUP] END createNode {}", nodeName);
    }
    ...
    public void createComEcimNode(final String nodeName, final String syncStatus, final SecurityLevel level, final String actionName)
        ...
        log.info("[NSCS_ARQ_DG2_NODES_DATA_SETUP] starting createComEcimNode {}", nodeName);
        ...
        try {
            modelInfoMap = nscsModelServiceImpl.getModelInfoList(TargetTypeInformation.CATEGORY_NODE, "RadioNode", ossModelIdentity, requestedModels);
        ...
        if ((modelInfoMap != null) && !modelInfoMap.isEmpty()) {
            ...
            final ManagedObject networkElment = createNetworkElement(liveBucket, parentMo, syncStatus, ossModelIdentity);
        ...
        log.info("[NSCS_ARQ_DG2_NODES_DATA_SETUP] END createComEcimNode {}", nodeName);
    }

    public void createComEcimNode(final String nodeName, final String syncStatus, final SecurityLevel level) throws Exception {
        log.info("[NSCS_ARQ_DG2_NODES_DATA_SETUP] starting createComEcimNode {} without action", nodeName);
        ...
        if ((modelInfoMap != null) && !modelInfoMap.isEmpty()) {
            ...
            final ManagedObject networkElement = createNetworkElementTree(liveBucket, meContextMO, syncStatus, ossModelIdentity);
        ...
        log.info("[NSCS_ARQ_DG2_NODES_DATA_SETUP] END createComEcimNode {} without action", nodeName);
    }
    ...
    private ManagedObject createNetworkElementTree(final DataBucket liveBucket, final ManagedObject siblingMo, final String syncStatus,
        ...
        final String networkElementName = networkElementNameFromMeContextName(siblingMo.getName());
        final ManagedObject networkElement = liveBucket.getMibRootBuilder().namespace(Model.NETWORK_ELEMENT.namespace())
                .type(Model.NETWORK_ELEMENT.type()).addAttribute(ModelDefinition.NetworkElement.NETWORK_ELEMENT_ID, "1")
                .addAttribute(NetworkElement.NE_TYPE, "RadioNode").addAttribute(ModelDefinition.NetworkElement.OSS_MODEL_IDENTITY, ossModelId)
                .name(networkElementName).version(NodeSecurityDataConstants.NETWORK_ELEMENT_VERSION).create();
        log.info("Created NetworkElement.....  name {}, managedObject {}", networkElementName, networkElement);

        networkElement.addAssociation("nodeRootRef", siblingMo);
        log.info("Created association {} <--> {}", siblingMo.getName(), networkElementName);

        liveBucket.getMibRootBuilder().namespace(Model.NETWORK_ELEMENT.securityFunction.namespace())
                .type(Model.NETWORK_ELEMENT.securityFunction.type()).addAttribute(ModelDefinition.SecurityFunction.SECURITY_FUNCTION_ID, "1")
                .name("1").version("1.0.0").parent(networkElement).create();
        ...
        liveBucket.getMibRootBuilder().namespace(Model.NETWORK_ELEMENT.cmFunction.namespace()).type(Model.NETWORK_ELEMENT.cmFunction.type())
                .addAttribute(ModelDefinition.CmFunction.SYNC_STATUS, syncStatus).name("1").version("1.0.0").parent(networkElement).create();
    ...
    private ManagedObject createNetworkElement(final DataBucket liveBucket, final ManagedObject siblingMo, final String syncStatus,
        ...
        final ManagedObject networkElement = liveBucket.getMibRootBuilder().namespace(Model.NETWORK_ELEMENT.namespace())
                ...
                .addAttribute(NetworkElement.NE_TYPE, "RadioNode").addAttribute(NetworkElement.OSS_MODEL_IDENTITY, ossModelId)
                .name(networkElementName).version(NodeSecurityDataConstants.NETWORK_ELEMENT_VERSION).create();
        log.info("Created NetworkElement.....  name {}, managedObject {}", networkElementName, networkElement);
    ...
    private ManagedObject createComEcimManagedElement(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        final Map<String, Object> mandatoryManagedElementAttributes = createMapAndInsertValues(
                ModelDefinition.ComEcimManagedElement.MANAGED_ELEMENT_ID, NodeSecurityDataConstants.MANDATORY_MANAGED_ELEMENT_ATTRIBUTE_VALUE);
    ...
    private ManagedObject createComEcimManagedElement(final DataBucket liveBucket, final String nodeName) {
        ...
        final String version = readerService.getModelVersion(Model.COM_MANAGED_ELEMENT.type(), ModelDefinition.COM_TOP_NS);

        log.info("Managed Element Version :: " + version);
        final ManagedObject managedElementMo = liveBucket.getMibRootBuilder().namespace(ModelDefinition.COM_TOP_NS)
    ...
    private ManagedObject createComEcimSystemFunctions(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        final Map<String, Object> mandatorySystemFunctionsAttributes = createMapAndInsertValues(
                ModelDefinition.ComEcimSystemFunctions.SYSTEM_FUNCTIONS_ID, NodeSecurityDataConstants.MANDATORY_SYSTEM_FUNCTIONS_ATTRIBUTE_VALUE);
    ...
    private ManagedObject createUserManagement(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        final Map<String, Object> mandatoryUserManagementAttributes = createMapAndInsertValues(ModelDefinition.UserManagement.USER_MANAGEMENT_ID,
                "1");
    ...
    private ManagedObject createLdapAuthenticationMethod(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        final Map<String, Object> mandatoryLdapAuthenticationMethodAttributes = createMapAndInsertValues(
                ModelDefinition.LdapAuthenticationMethod.LDAP_AUTHENTICATION_METHOD_ID, "1");
    ...
    private ManagedObject createLdap(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        mandatoryLdapAttributes.put(ModelDefinition.Ldap.SERVER_PORT, 1636);
        mandatoryLdapAttributes.put(ModelDefinition.Ldap.BASE_DN, "uid=ssouser,ou=people,dc=apache,dc=com");
        mandatoryLdapAttributes.put(ModelDefinition.Ldap.BIND_DN, "cn=ProxyAccount_5,ou=Profiles,dc=apache,dc=com");
        mandatoryLdapAttributes.put(ModelDefinition.Ldap.TLS_MODE, "STARTTLS");
        mandatoryLdapAttributes.put(ModelDefinition.Ldap.USE_TLS, true);
        mandatoryLdapAttributes.put(ModelDefinition.Ldap.LDAP_ID, "1");
    ...
    private ManagedObject createSecM(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        final Map<String, Object> mandatorySecMAttributes = createMapAndInsertValues(ModelDefinition.SecM.SEC_M_ID, "1");
    ...
    private ManagedObject createCertM(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        final Map<String, Object> mandatoryCertMAttributes = createMapAndInsertValues(ModelDefinition.CertM.CERT_M_ID, "1",
                ModelDefinition.CertM.REPORT_PROGRESS, null);
    ...
    private ManagedObject createCertMCapabilities(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        enrollmentSupportList.add(ModelDefinition.CertMCapabilities.EnrollmentSupport.ONLINE_SCEP.name());

        final Map<String, Object> mandatoryCertMCapabilitiesAttributes = new HashMap<String, Object>();
        mandatoryCertMCapabilitiesAttributes.put(ModelDefinition.CertMCapabilities.CERT_M_CAPABILITIES_ID, "1");
        mandatoryCertMCapabilitiesAttributes.put(ModelDefinition.CertMCapabilities.ENROLLMENT_SUPPORT, enrollmentSupportList);
    ...
    private ManagedObject createTrustCategory(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        mandatoryTrustCategoryAttributes.put(ModelDefinition.TrustCategory.TRUST_CATEGORY_ID, "1");
    ...
    public void deleteAllNodes() throws Exception {
        ...
        deleteAllNodes(ModelDefinition.COM_TOP_NS, Model.COM_MANAGED_ELEMENT.type());
    ...
    private void createNode(final String nodeName) throws Exception {
        createNode(nodeName, ModelDefinition.CmFunction.SyncStatusValue.SYNCHRONIZED.name());
    }

    public ManagedObject createManagedElement(final DataBucket liveBucket, final ManagedObject parentMo) {

        ManagedObject managedElementMo = null;
        final Map<String, Object> mandatoryManagedElementAttributes = createMapAndInsertValues(
        ...
        String ossModelIdentity = getTargetModelIdentityForTestNode(NodeSecurityDataConstants.RADIO_TARGET_TYPE);
        NscsModelInfo modelInfo = nscsModelServiceImpl.getModelInfo(TargetTypeInformation.CATEGORY_NODE, NodeSecurityDataConstants.RADIO_TARGET_TYPE,
                ossModelIdentity, managedElementType);
        if (modelInfo != null) {
            managedElementMo = liveBucket.getMibRootBuilder().namespace(modelInfo.getNamespace()).type(Model.ME_CONTEXT.comManagedElement.type())
                    .version(modelInfo.getVersion()).name(NodeSecurityDataConstants.MO_NAME).addAttributes(mandatoryManagedElementAttributes)
    ...
    public ManagedObject createSystemFunctions(final DataBucket liveBucket, final ManagedObject parentMo) {
        ...
        ManagedObject systemFunctionsMo = null;
        final Map<String, Object> mandatorySystemFunctionsAttributes = createMapAndInsertValues(
        ...
        String ossModelIdentity = getTargetModelIdentityForTestNode(NodeSecurityDataConstants.RADIO_TARGET_TYPE);
        NscsModelInfo modelInfo = nscsModelServiceImpl.getModelInfo(TargetTypeInformation.CATEGORY_NODE, NodeSecurityDataConstants.RADIO_TARGET_TYPE,
                ossModelIdentity, systemFunctionsType);
        if (modelInfo != null) {
            systemFunctionsMo = liveBucket.getMibRootBuilder().namespace(modelInfo.getNamespace()).type(systemFunctionsType)
                    .version(modelInfo.getVersion()).name(NodeSecurityDataConstants.MO_NAME).addAttributes(mandatorySystemFunctionsAttributes)
                    .parent(parentMo).create();
        }
        return systemFunctionsMo;
    }
    ...
    private ManagedObject createNodeCredential(final DataBucket liveBucket, final ManagedObject parentMo, final String name,
        ...
        enrollmentProgressAttributes.put(ModelDefinition.AsyncActionProgress.ACTION_ID, "1");

        final Map<String, Object> mandatoryNodeCredentialAttributes = new HashMap<>();
        mandatoryNodeCredentialAttributes.put(ModelDefinition.NodeCredential.NODE_CREDENTIAL_ID, "1");
        //mandatoryNodeCredentialAttributes.put(ModelDefinition.NodeCredential.ENROLLMENT_PROGRESS, enrollmentProgressAttributes);
    ...
    public void createComEcimNodeForCrlCheck(final String nodeName, final String syncStatus, final SecurityLevel level, final String actionName)
            throws Exception {
        log.info("[NSCS_ARQ_DG2_NODES_DATA_SETUP] starting createComEcimNodeForCrlCheck {}", nodeName);
        ...
        log.info("[NSCS_ARQ_DG2_NODES_DATA_SETUP] END createComEcimNodeForCrlCheck {}", nodeName);
    }
    ...
    private ManagedObject createComEcimSysM(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        mandatorySysMAttributes.put(ModelDefinition.SysM.SYS_M_ID, "1");
    ...
    private ManagedObject createComEcimNetconfTls(final DataBucket liveBucket, final ManagedObject parentMo, final NscsModelInfo modelInfo) {
        ...
        mandatoryNetconfTlsAttributes.put(ModelDefinition.NetconfTls.NETCONF_TLS_ID, "1");
        mandatoryNetconfTlsAttributes.put(ModelDefinition.NetconfTls.TRUST_CATEGORY, "1");
    ...
    private ManagedObject createCertMCapabilitiesForCrlCheck(final DataBucket liveBucket, final ManagedObject parentMo,
        ...
        final List<String> enrollmentSupportList = new ArrayList<>();
        enrollmentSupportList.add(ModelDefinition.CertMCapabilities.EnrollmentSupport.ONLINE_CMP.name());
    ...
    public void createComEcimNodeForCiphersConfig(final String nodeName, final String syncStatus, final String ossModelId) throws Exception {
        log.info("[NSCS_ARQ_DG2_NODES_DATA_SETUP] starting createComEcimNodeForCiphersConfig {}", nodeName);

        beginTransaction();

        NscsModelInfo modelInfo = null;
        try {
            modelInfo = nscsModelServiceImpl.getModelInfo(TargetTypeInformation.CATEGORY_NODE, NodeSecurityDataConstants.RADIO_TARGET_TYPE,
                    ossModelId, systemFunctionsType);
        } catch (IllegalArgumentException | NscsModelServiceException ex) {
        ...
        log.info("[NSCS_ARQ_DG2_NODES_DATA_SETUP] END createComEcimNodeForCiphersConfig {}", nodeName);
    }

    /**
     * Create a ComEcim node suitable for Ciphers tests.
     *
     * @param nodeName
     *            the node name
     * @param syncStatus
     ...
     */
    public void createComEcimNodeForCiphersConfig(final String nodeName, final String syncStatus, final Boolean ciphersConfigurationSupported)
            throws Exception {
        log.info("Creating ECIM node with Ciphers configuration support [{}]", ciphersConfigurationSupported);
        final String targetModelIdentity = getTargetModelIdentityForCiphersTestNode(NodeSecurityDataConstants.RADIO_TARGET_TYPE,
                ciphersConfigurationSupported);
        this.createComEcimNodeForCiphersConfig(nodeName, syncStatus, targetModelIdentity);
    }
    ...
    private ManagedObject createTlsMo(final DataBucket liveBucket, final ManagedObject parentMo) {
        ...
        final Map<String, Object> mandatoryTlsAttributes = createMapAndInsertValues(ModelDefinition.SecMTls.TLS_ID, "1");
    ...
    private ManagedObject createSshMo(final DataBucket liveBucket, final ManagedObject parentMo) {
        final Map<String, Object> mandatorySshAttributes = createMapAndInsertValues(ModelDefinition.SecMSsh.SSH_ID, "1");
