...
public class NscsDpsSecurityEventListener implements EMessageListener<DpsDataChangedEvent> {

    private final Logger logger = LoggerFactory.getLogger(NscsDpsSecurityEventListener.class);
    ...
    public void onMessage(final DpsDataChangedEvent event) {
        logger.debug("Security message received from DPS.\n" + event);
